...
/**
 * Brand marks are filled shapes, so they use their own component rather than
 * the stroke-based `Icon` set the services use.
 *
 * NOTE: hrefs are placeholders — swap in the firm's real profile URLs.
 */
const SOCIALS = [
  {
    label: "LinkedIn",
